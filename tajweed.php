...
<head>
    ...
    <link rel="stylesheet" href="css/taj_css.css">
    <link rel="stylesheet" href="css/taj2_css.css">
</head>
...
<body>
    ...
    <div class="line"></div>
    <div class=" logout" >
        <h3><a href="mytajweed.php">العودة للصفحة السابقة
    ...
    <div class="header-info">
        <h1> جدول الطلاب في حلقات التجويد</h1>
        <p>اسم المشرف: <?php echo $_SESSION['name'] ?></p>
    </div>
    <form action="./php/users_tajweed.php" method="POST">
        ...
        <table>
            ...
            <tbody>
                ...
                if ($result->num_rows == 0) {
                    ...
                    while ($student_tajweed = $result->fetch_assoc()) {

                        echo ' <tr class="new-student">
                <td><input type="text" name="name" value="' . $student_tajweed['name'] . '" placeholder="اسم الطالب" style="border: none; height: 40px;"></td>
                <td><input type="text" name="phone" value="' . $student_tajweed['phone'] . '" placeholder="رقم الهاتف" style="border: none; height: 40px;"></td>
                <td><input type="text" name="father_phone" value="' . $student_tajweed['father_phone'] . '" placeholder="رقم هاتف ولي الأمر" style="border: none; height: 40px;"></td>
                <td><input type="text" name="description" value="' . $student_tajweed['description'] . '" placeholder="ملاحظات" style="border: none; height: 40px;"></td>
                <td>
                    <input type="hidden" name="id" value="' . $student_tajweed['id'] . '">                    
    ...
    <div class="button-container">
        <button class="add-button" onclick="addStudent()">إضافة طالب</button>
    </div>
